...
//   affin:  any  = (data  as  any).default;
  ...
  basicChart3() {
    var sales_17 = [1000,100,1600,1990,9955,12870,11930,10320,11845,12660,15220,23390]
    
    var sales_18 = [16590,11080,14200,20265,14650,17560,19805,15755,13610,13155,14260,17190,]

    var sales_19 = [13235,6910,12087,11940,19600,18630,8910,16220,11130,12470,11610,3123]
